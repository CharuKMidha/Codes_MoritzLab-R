...
#When the button is clicked, the following happens in order (see code snippet #4): 
# 1) a data frame is made with both variables in it, 
# 2) the correlation analysis is run, 
# 3) the output data frame is made, 
# 4) the table is rendered, 
# 5) the plot is created, 
# 6) the additional elements are drawn conditionally and, 
# 7) the plot is rendered.
